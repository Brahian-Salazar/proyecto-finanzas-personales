...
import { guardarDatos, cargarDatos } from "./Persistencia.js"

async function pruebasControladas(){
  ...
  imprimirTitulo("GUARDAR DATOS");
  imprimirResultado("GUARDAR DATOS", await guardarDatos(transacciones.listaTransacciones));

  imprimirTitulo("CARGAR DATOS");
  imprimirResultado("CARGAR DATOS", await cargarDatos());
